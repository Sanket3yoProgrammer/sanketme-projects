      ...
      <div className="relative z-20">
        <div className="relative">
          ...
          <img 
            ...
            alt="Profile" 
            className="w-32 h-32 rounded-full border-[10px] border-gray-900 shadow-2xl absolute left-1/2 transform -translate-x-1/2 -bottom-16 bg-gradient-to-r from-sky-200 to-sky-400"
          />
        </div>
